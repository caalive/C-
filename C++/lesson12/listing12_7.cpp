/*************************************************************************
	> File Name: listing12_7.cpp
	> Author: 
	> Mail: 
	> Created Time: Sun 03 Dec 2017 02:02:53 PM CST
 ************************************************************************/
...
int main()
{
    ...
    if(holiday2 > holiday1)
        cout << "operator>: holiday2 happens laster" << endl;

    if(holiday1 <= holiday2)
        cout << "operator<=: holiday1 happens on or brefore holiday2" << endl;
